...
<html lang="en">
	<head>
		...
		<!-- Slick -->
		<link href= '<c:url value="/templates/guest/css/slick.css" />' rel="stylesheet" type="text/css">
		<link href= '<c:url value="/templates/guest/css/slick-theme.css" />' rel="stylesheet" type="text/css">
