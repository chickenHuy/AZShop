...
<body>
	...
	<script
		src="<c:url value="/templates/account/js/jquery.min.js"></c:url>"></script>
	<script
		src="<c:url value="/templates/account/js/popper.min.js"></c:url>"></script>
	<script
		src="<c:url value="/templates/account/js/bootstrap.min.js"></c:url>"></script>
