...
<body>
 ...
 <link rel="stylesheet" type="text/css" href="<c:url value="/templates/account/assets/vendor/quill/quill.snow.css" />">
 <link rel="stylesheet" type="text/css" href="<c:url value="/templates/account/assets/vendor/quill/quill.bubble.css" />">
 <link rel="stylesheet" type="text/css" href="<c:url value="/templates/account/assets/vendor/remixicon/remixicon.css" />">
 <link rel="stylesheet" type="text/css" href="<c:url value="/templates/account/assets/vendor/simple-datatables/style.css" />">
 ...
 <link rel="stylesheet" type="text/css" href="<c:url value="/templates/account/assets/css/style.css" />">
    ...
    <!-- Vendor JS Files -->
    <script src="<c:url value='/templates/account/assets/vendor/apexcharts/apexcharts.min.js' />"></script>
    <script src="<c:url value='/templates/account/assets/vendor/bootstrap/js/bootstrap.bundle.min.js' />"></script>
    ...
    <script src="<c:url value='/templates/account/assets/vendor/simple-datatables/simple- datatables.js' />"></script>
