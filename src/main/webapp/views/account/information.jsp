	...
	<%@ include file="/common/taglib.jsp" %>
		<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
			...
			<body>
					...
					<nav class="header-nav ms-auto">
						<ul class="d-flex align-items-center">
							...
							<li class="nav-item dropdown pe-3"><a
									...
									data-bs-toggle="dropdown"> <img src="/AZShop/image?fname=${user.avatar}"
										alt="Profile" class="rounded-circle"> <span
										class="d-none d-md-block dropdown-toggle ps-2"
										style="color:#ffffff;">${user.email}</span>
								</a>
								...
								<ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
									...
									<li><a class="dropdown-item d-flex align-items-center"
											href="<c:url value='/logout-customer' />"> <i
										...
										<div class="tab-content pt-2">
											...
											<div class="tab-pane fade profile-edit pt-3" id="profile-edit">
												...
												<form action="update-infor" method="post" enctype="multipart/form-data">
													...
													<div class="row mb-3">
														<label for="company"
															class="col-md-4 col-lg-3 col-form-label">Cart Id</label>
														<div class="col-md-8 col-lg-9">
													...
													<div class="row mb-3">
														...
														<div class="col-md-8 col-lg-9">
															<input name="phone" type="text" class="form-control"
																id="phone" pattern="[0-9]+" title="Chỉ được nhập số"
													...
													<div class="row mb-3">
														<label for="Phone"
															class="col-md-4 col-lg-3 col-form-label">Point</label>
														<div class="col-md-8 col-lg-9">
													...
													<div class="row mb-3">
														<label for="Email"
															class="col-md-4 col-lg-3 col-form-label">EWallet</label>
														<div class="col-md-8 col-lg-9">
											...
											<div class="tab-pane fade pt-3" id="profile-order">
												<ul class="nav nav-tabs nav-tabs-bordered">
													<li class="nav-item">
														<button class="nav-link active" data-bs-toggle="tab"
															data-bs-target="#order-waiting">Waiting</button>
													</li>
													<li class="nav-item">
														<button class="nav-link" data-bs-toggle="tab"
															data-bs-target="#order-processing">Processing</button>
													</li>
													<li class="nav-item">
														<button class="nav-link" data-bs-toggle="tab"
															data-bs-target="#order-pending">Pending Pickup</button>
													</li>
													<li class="nav-item">
														<button class="nav-link" data-bs-toggle="tab"
															data-bs-target="#order-shipping">Shipping</button>
													</li>
													<li class="nav-item">
														<button class="nav-link" data-bs-toggle="tab"
															data-bs-target="#order-delivered">Delivered</button>
													</li>
													<li class="nav-item">
														<button class="nav-link" data-bs-toggle="tab"
															data-bs-target="#order-completed">Completed</button>
													</li>
													<li class="nav-item">
														<button class="nav-link" data-bs-toggle="tab"
															data-bs-target="#order-cancelled">Cancelled</button>
													</li>
												</ul>
														...
														<table class="table datatable">
															<thead>
																<tr>
																	...
																	<th>Status</th>
																	<th>Phone</th>
																	<th data-type="date" data-format="YYYY/DD/MM">Time
																	</th>
																	<th>Action</th>
																</tr>
															</thead>
															<tbody>
																<c:forEach var="order" items="${orderListWaiting}">
																	<tr>
																		...
																		<td>
																			<a href="/AZShop/detailOrder?id=${order.id}"
															...
															<tbody>
																<c:forEach var="order" items="${orderListProcessing}">
																	<tr>
																		...
																		<td>${order.phone}</td>
																		<td>${order.createAt}</td>
																		<td><a href="/AZShop/detailOrder?id=${order.id}"
				...
				<script src="<c:url value='/templates/account/assets/vendor/chart.js/chart.umd.js' />"></script>
				<script src="<c:url value='/templates/account/assets/vendor/echarts/echarts.min.js' />"></script>
				<script src="<c:url value='/templates/account/assets/vendor/quill/quill.min.js' />"></script>
				<script
					src="<c:url value='/templates/account/assets/vendor/simple-datatables/simple-datatables.js' />"></script>
				<script src="<c:url value='/templates/account/assets/vendor/tinymce/tinymce.min.js' />"></script>
				<script src="<c:url value='/templates/account/assets/vendor/php-email-form/validate.js' />"></script>
				...
				<script>
					document.getElementById("saveButton").addEventListener("click", function (event) {
						...
						if (isNaN(phoneNumber) || phoneNumber.length !== 10) {
							event.preventDefault(); // Ngăn chặn việc gửi dữ liệu khi không đáp ứng yêu cầu
							alert("Vui lòng nhập một số có 10 chữ số.");
						}
					});
					document.addEventListener("DOMContentLoaded", function () {
						// Hàm này sẽ được gọi khi trang đã được load
						setPhoneValue();
					});

					function setPhoneValue() {
						// Lấy giá trị điện thoại từ server hoặc từ nguồn dữ liệu khác
						var phoneValue = "${user.phone}";

						// Đặt giá trị vào ô điện thoại
