									...
									<tr>
										...
										<td><c:choose>
												<c:when test="${user.emailActive }">
													<span
														class="lable-table bg-success-subtle text-success rounded border border-success-subtle font-text2 fw-bold"><i
														class="bi bi-check2 ms-2"></i></span>

												</c:when>
												<c:otherwise>
													<span
														class="lable-table bg-danger-subtle text-danger rounded border border-danger-subtle font-text2 fw-bold"><i
