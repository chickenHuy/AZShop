            ...
            <div class="col">
                ...
                <div class="card radius-10 border-0 border-start border-success border-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="">
                                <p class="mb-1">Total Follower</p>
                                <h4 class="mb-0 text-success">${totalFL}</h4>
                            </div>
                            <div class="ms-auto widget-icon bg-success text-white">
                                <i class="bi bi-currency-dollar"></i>
                            </div>
			...
			<div class="col">
                <div class="card radius-10 border-0 border-start border-success border-4">
	              ...
	              <ul class="list-group list-group-flush mb-0">
	                <li class="list-group-item border-top d-flex justify-content-between align-items-center bg-transparent">New Store<span class="badge bg-success rounded-pill">${((count/total)*100)}%</span>
	                </li>
	                <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent">Other Store<span class="badge bg-primary rounded-pill">${(((total-count)/total)*100)}%</span>
	                </li>
