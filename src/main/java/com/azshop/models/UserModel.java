...
public class UserModel implements Serializable {
	...
	public UserModel(int id, String firstName, String lastName, String slug, String cartId, String email, String phone,
			...
			String role, int userLevelId, String avatar, String coverImage, String address, int point,
	...
	public String toString() {
		return "UserModel [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", slug=" + slug
				...
				+ avatar + ", coverImage=" + coverImage + ", address=" + address + ", point=" + point + ", eWallet="
